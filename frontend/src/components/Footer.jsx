const Footer = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-blue-500 to-rose-500 opacity-50"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
          ...
          <div className="md:text-right">
            ...
            <div className="space-y-3 text-slate-300">
              ...
              <p className="flex items-center md:justify-end gap-2">
                <span className="text-blue-400">ID LINE:</span>
                16273551
              </p>
            </div>
          </div>
