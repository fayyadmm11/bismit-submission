const Hero = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-10 left-1/2 -translate-x-1/2 w-3/4 h-3/4 bg-gradient-to-br from-blue-600/20 to-rose-600/20 blur-[100px] rounded-full z-0 pointer-events-none"></div>
